...
namespace maxstAR
{
	...
	public class TrackerManager
	{
		...
		/// <summary>
		/// Space Tracker (need ARKit, ARCore)
		/// </summary>
		public const int TRACKER_TYPE_SPACE = 0x8000;
		...
		public TrackingState UpdateTrackingState()
		{
            ...
            trackingStateCPtr = NativeAPI.maxst_TrackerManager_updateTrackingState(0);
		...
		public TrackingState UpdateTrackingState(int mode)
		{
			ulong trackingStateCPtr = 0;

			trackingStateCPtr = NativeAPI.maxst_TrackerManager_updateTrackingState(mode);
