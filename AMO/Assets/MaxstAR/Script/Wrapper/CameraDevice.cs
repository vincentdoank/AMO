...
namespace maxstAR
{
    ...
    public class CameraDevice
    {
        ...
        {
            return (ResultCode)NativeAPI.maxst_CameraDevice_startSimulator(folderPath);
        }

        public void SetExternalCamera(bool enable)
        {
            NativeAPI.maxst_CameraDevice_setExternalCamera(enable);
        }
        ...
        public void SetNewFusionCameraFrameAndPoseAndTimestamp(byte[] data, int length, int width, int height, ColorFormat format, float[] pose, ulong timestamp)
        {
            NativeAPI.maxst_CameraDevice_setNewFusionCameraFrameAndPoseAndTimestamp(data, length, width, height, format, pose, timestamp);
        }

        public bool SetNewFrameAndPoseAndIntrinsicAndTimestamp(byte[] data, int length, int width, int height, ColorFormat format, float[] pose, float[] intrinsic, ulong timestamp)
        {
            return NativeAPI.maxst_CameraDevice_setNewFrameAndPoseAndIntrinsicAndTimestamp(data, length, width, height, format, pose, intrinsic, timestamp);
        }

        public bool SetCalibrationDatas(int width, int height, float fx, float fy, float px, float py)
        {
            return NativeAPI.maxst_CameraDevice_setCalibrationDatas(width, height, fx, fy, px, py);
        }
        
        public void SetCameraSize(int width, int height)
        {
            NativeAPI.maxst_CameraDevice_setCameraSize(width, height);
        }
