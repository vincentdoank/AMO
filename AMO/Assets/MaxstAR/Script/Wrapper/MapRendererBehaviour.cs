...
namespace maxstAR
{
	...
	public class MapRendererBehaviour : MonoBehaviour
	{
		...
		internal void Create(Vector3[] vertices, Matrix4x4[] cameraMatrices, Material[] materials)
		{
			...
			ARManager arManager = Camera.main.GetComponent<ARManager>();
        ...
        internal void CreateAnchors(TagAnchor[] anchors)
        {
            ...
            for (int i = 0; i < anchors.Length; i++)
            {
                ...
                Vector3 scale = new Vector3(eachAnchor.scaleX * SCALE_FACTOR, eachAnchor.scaleY * SCALE_FACTOR, eachAnchor.scaleZ * SCALE_FACTOR);
