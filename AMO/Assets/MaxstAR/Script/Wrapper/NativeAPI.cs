...
namespace maxstAR
{
    internal class NativeAPI
    {
        ...
        const string MaxstARLibName = "libMaxstAR";
#else
        ...
        [DllImport(MaxstARLibName)]
        public static extern void maxst_CameraDevice_setExternalCamera(bool enable);
        ...
        [DllImport(MaxstARLibName)]
        public static extern void maxst_CameraDevice_setNewFusionCameraFrameAndPoseAndTimestamp(byte[] data, int length, int width, int height, ColorFormat format, float[] pose, ulong timestamp);

        [DllImport(MaxstARLibName)]
        public static extern bool maxst_CameraDevice_setNewFrameAndPoseAndIntrinsicAndTimestamp(byte[] data, int length, int width, int height, ColorFormat format, float[] pose, float[] intrinsic, ulong timestamp);

        [DllImport(MaxstARLibName)]
        public static extern bool maxst_CameraDevice_setCalibrationDatas(int width, int height, float fx, float fy, float px, float py);

        [DllImport(MaxstARLibName)]
        public static extern void maxst_CameraDevice_setCameraSize(int width, int height);
        ...
        [DllImport(MaxstARLibName)]
        public static extern void maxst_CameraDevice_setClippingPlane(float near, float far);
        #endregion
        ...
        [DllImport(MaxstARLibName)]
        public static extern ulong maxst_TrackerManager_updateTrackingState(int mode);
