...
namespace maxstAR
{
    public class MaxstARUtil : MonoBehaviour
    {
        ...
        public static void LoadImageFromFileWithSizeAndTexture(string path, System.Action<int, int, Texture2D> complete)
        {
            ...
            if (complete != null)
            {
                complete(imgTexture.width, imgTexture.height, imgTexture);
            }
        }
